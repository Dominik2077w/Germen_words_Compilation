...
3. 最近：
   ...
   - **结果**：我们开发了第二版项目，使用python语言和DeepSeek V3 API,以及开源工具MinerU。提取归类出每个科目每节课的固定搭配和老师的口语表达

4. 后来：
   emmmm，这个项目基本废弃了「doge」。 
   原因是：
   1.基本没什么生词之后，也就没有结构化分析生词的必要了
   2.至于固定搭配和口语表达的分析，GPT桌面端的功能非常全面，配套齐全。转GPT了(更重要的是，这个也只是兴起学一下，不是学的很勤:D)
## 结语
然后的最近的生活就是使用***GPT桌面端*** + [小米同声传译传译扩展app](https://github.com/Dominik2077w/Xiaomi15_Translator_Plus)(也是我开发的:D)
