...
4. 后来：
   ...
   2.至于固定搭配和口语表达的分析，GPT桌面端的会员功能非常全面，配套齐全。转GPT会员了(更重要的是，这个也只是兴起学一下，不是学的很勤:D)
## 结语
然后的最近的生活就是使用***GPT桌面端会员*** + [小米同声传译传译扩展app](https://github.com/Dominik2077w/Xiaomi15_Translator_Plus)(也是我开发的:D)
